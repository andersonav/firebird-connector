...
namespace AndersonAv\Firebird\Schema\Grammars;
...
class FirebirdGrammar extends Grammar
{
    ...
    public function compileDropIfExists(Blueprint $blueprint, Fluent $command)
    {
        ...
        return sprintf(
            ...
            str_replace('?', $table, $this->compileTableExists('', $table)),
    ...
    public function compileForeign(Blueprint $blueprint, Fluent $command)
    {
        ...
        if (!is_null($command->onDelete)) $sql .= " ON DELETE {$command->onDelete}";
        if (!is_null($command->onUpdate)) $sql .= " ON UPDATE {$command->onUpdate}";
     ...
     */
    public function compileJoinLateral($query, $join)
    {
        // Firebird não suporta JOIN LATERAL diretamente
        throw new \LogicException('Firebird does not support LATERAL joins.');
    }
    ...
    {
        return !is_null($column->charset) ? ' CHARACTER SET ' . $column->charset : null;
    }
    ...
    {
        return !is_null($column->collation) ? ' COLLATE ' . $column->collation : null;
    }
    ...
    {
        return !is_null($column->default) ? ' DEFAULT ' . $this->getDefaultValue($column->default) : null;
    }
